...
Since you cannot use real money during development, Spotflow provides a [**Funding Simulator Web App**](https://d2i9iv7q8xti2t.cloudfront.net/) so you can safely send fake money to your test accounts.
