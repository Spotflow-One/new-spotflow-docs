...
sidebarTitle: "Funding Simulator"
...
## 🏗️ Supported Ways to Add Test Funds
...
2. **Open the web app:** Launch the [Funding Simulator](https://spotflow-funding-simulator.vercel.app/).
3. **Fill out the form:**
