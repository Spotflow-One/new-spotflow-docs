...
You can use our [Fund Simulator App](https://spotflow-funding-simulator.vercel.app/) to add fake funds for transfers/accounts crediting. Please refer to our [Adding Fake Funds For Testing](/expert-desk/simulating-funds) guide to know more.
