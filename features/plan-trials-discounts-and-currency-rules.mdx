...
<ParamField body="trial" type="object">
  ...
  <Expandable title="properties">
    <ParamField body="periodInDays" type="integer" required>
      The duration of the trial window in calendar days (e.g. `7` or `14`).
    </ParamField>
    <ParamField body="pricingList" type="array">
      The price to charge during the trial period. To make the trial 100% free, set the amount to `0`. If omitted, the trial defaults to free.
      <Expandable title="properties">
        <ParamField body="amount" type="number" required>
          The promotional price during the trial window.
        </ParamField>
...
```bash African Regional Plan with Free Trial
curl --request POST \
