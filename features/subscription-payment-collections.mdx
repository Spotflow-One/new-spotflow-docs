...
Create recurring products either directly in your Spotflow Dashboard or programmatically via API.
...
| ---                            | ---                                                                            | ---                                                       |
| **Create Subscription**        | [POST /subscriptions](/api-reference/subscription-plans/create-single-plan)    | Create a new subscription programmatically.               |
| **Update Subscription**        | [PATCH /subscriptions/{id}](/api-reference/wallets/spotflow-wallet-id)         | Modify quantities, change plans, or set cancellation.     |         
| **List/Retrieve Subscription** | [GET /subscriptions](/api-reference/wallets/main-account-balance)              | View all or retrieve details for a single subscription.   |
...
| **payment_failed**                                        | Alerts you when an attempted charge is declined.           | {"event": "payment_failed", ...}          |             
...
To learn more about what you can do with plans on Spotflow, check out our [API Reference](/api-reference/subscription-plans/create-single-plan). If you've got any questions, don’t hesitate to reach out to our team at support@spotflow.one.