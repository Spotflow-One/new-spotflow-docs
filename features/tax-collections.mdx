...
Whether you need to charge a percentage tax (like VAT) or a fixed fee (like stamp duty), you can set everything up automatically using either your **Spotflow Dashboard** or the **Tax APIs**.
