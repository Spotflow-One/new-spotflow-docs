# Contributing to Spotflow's Documentation
...
1. **Fork the Repository**
   ```bash
   # Navigate to https://github.com/spotflow-one/spotflow-documentation
...
const apiKey = process.env.SPOTFLOW_API_KEY;
```
````
...
Spotflow uses Mintlify to maintain its documentation page. Please check the [Mintlify Documentation](https://mintlify.com/docs) for all available components.
...
- Consider joining our Slack Community to stay connected
...
- **Exclusive Merch/Vouchers**: Exceptional contributors may receive Spotflow merchandise or vouchers as a token of our appreciation
...
- **Discord**: Join our [Slack community](https://slack/bYqAp4ayYh)
- **GitHub Issues**: Open an issue for bugs or suggestions
- **Email**: support@spotflow.one for direct support
