---
title: Introduction 
description: Welcome to the Spotflow Core - This section contains everything you need to successfully integrate, test, master and go live with the Spotflow platform.
icon: "book-open"
---
...
<CardGroup cols={1}>
  <Card title="Webhooks" icon="bell" href="/developer-resources/webhooks/overview">
